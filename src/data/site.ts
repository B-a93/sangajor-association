...
export const navItems = [['Home','#/'],['About','#/about'],['Leadership','#/leadership'],['Membership','#/membership'],['Focus Areas','#/focus'],['Updates','#/updates'],['Our Journey','#/journey'],['Contact','#/contact']];
