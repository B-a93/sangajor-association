...
const learningCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Everyday Cooking Skills', description: 'Learn safe food handling, kitchen organisation and reliable methods for preparing balanced, flavourful everyday meals.' },
      { name: 'Practical Baking Skills', description: 'Build reliable baking skills through accurate measuring, ingredient science, dough and batter methods, oven control, decoration and safe production.' },
    ],
  },
  {
...
function CourseCard({ skill }: { skill: { readonly name: string; readonly description: string } }) {
  const lessonHref = skill.name === 'Digital Income & Online Work' ? '#/dashboard/learning/digital-income' : skill.name === 'Everyday Digital & Technology Skills' ? '#/dashboard/learning/everyday-digital-technology-skills' : skill.name === 'Everyday Cooking Skills' ? '#/dashboard/learning/everyday-cooking-skills' : skill.name === 'Practical Baking Skills' ? '#/dashboard/learning/practical-baking-skills' : null;
